...
const genesisBlock = new Block(0, "23423423423423", "", "firstblockdata", 12345); //first block
...
const getHashforBlock = (aBlock) => Block.calculateBlockHash(aBlock.index, aBlock.previousHash, aBlock.timestamp, aBlock.data); //validate Hash
